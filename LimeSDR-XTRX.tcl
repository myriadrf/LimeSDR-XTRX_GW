...
#
# Generated by Vivado on Wed Jan 11 11:59:16 +0200 2023
...
#    "Z:/Work/LimeSDR-XTRX/src/hdl/dyn_ps/synth/pll_ps.vhd"
#    "Z:/Work/LimeSDR-XTRX/src/hdl/dyn_ps/synth/pll_ps_fsm.vhd"
#    "Z:/Work/LimeSDR-XTRX/src/hdl/dyn_ps/synth/pll_ps_top.vhd"
...
#    "Z:/Work/LimeSDR-XTRX/src/mb_elf/cpu.elf"
...
proc create_hier_cell_SMPL_CMP_GPIO { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 smpl_cmp_sel
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M16_AXI [get_bd_intf_pins S_AXI2] [get_bd_intf_pins smpl_cmp_sel/S_AXI]
  connect_bd_intf_net -intf_net smpl_cmp_cmd_GPIO [get_bd_intf_pins smpl_cmp_en] [get_bd_intf_pins smpl_cmp_cmd/GPIO]
  connect_bd_intf_net -intf_net smpl_cmp_sel_GPIO [get_bd_intf_pins smpl_cmp_sel] [get_bd_intf_pins smpl_cmp_sel/GPIO]
  connect_bd_intf_net -intf_net smpl_cmp_stat_GPIO [get_bd_intf_pins smpl_cmp_status] [get_bd_intf_pins smpl_cmp_stat/GPIO]

  # Create port connections
  connect_bd_net -net microblaze_0_Clk [get_bd_pins Clk] [get_bd_pins smpl_cmp_cmd/s_axi_aclk] [get_bd_pins smpl_cmp_sel/s_axi_aclk] [get_bd_pins smpl_cmp_stat/s_axi_aclk]
  connect_bd_net -net rst_Clk_100M_peripheral_aresetn [get_bd_pins extm_axi_resetn_out] [get_bd_pins smpl_cmp_cmd/s_axi_aresetn] [get_bd_pins smpl_cmp_sel/s_axi_aresetn] [get_bd_pins smpl_cmp_stat/s_axi_aresetn]
...
proc create_hier_cell_PLL_GPIO { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net microblaze_0_Clk [get_bd_pins Clk] [get_bd_pins PLLCFG_Command/s_axi_aclk] [get_bd_pins PLLCFG_Status/s_axi_aclk] [get_bd_pins PLL_RST/s_axi_aclk] [get_bd_pins PLL_SEL/s_axi_aclk]
  connect_bd_net -net rst_Clk_100M_peripheral_aresetn [get_bd_pins extm_axi_resetn_out] [get_bd_pins PLLCFG_Command/s_axi_aresetn] [get_bd_pins PLLCFG_Status/s_axi_aresetn] [get_bd_pins PLL_RST/s_axi_aresetn] [get_bd_pins PLL_SEL/s_axi_aresetn]
...
proc create_hier_cell_I2C_CORES { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M16_AXI [get_bd_intf_pins SMPL_CMP_GPIO/S_AXI2] [get_bd_intf_pins microblaze_0_axi_periph/M16_AXI]
  ...
  connect_bd_intf_net -intf_net smpl_cmp_sel_GPIO [get_bd_intf_ports smpl_cmp_sel] [get_bd_intf_pins SMPL_CMP_GPIO/smpl_cmp_sel]
  ...
  assign_bd_address -offset 0x40070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs SMPL_CMP_GPIO/smpl_cmp_sel/S_AXI/Reg] -force
