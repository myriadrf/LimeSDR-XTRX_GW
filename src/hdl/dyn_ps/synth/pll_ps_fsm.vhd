...
--attribute MARK_DEBUG of ps_en             : signal is "TRUE";
--attribute MARK_DEBUG of ps_reset_at_start : signal is "TRUE";
--attribute MARK_DEBUG of ps_mode           : signal is "TRUE";
--attribute MARK_DEBUG of ps_cnt            : signal is "TRUE";               
--attribute MARK_DEBUG of ps_updwn          : signal is "TRUE";
--attribute MARK_DEBUG of ps_phase          : signal is "TRUE";             
--attribute MARK_DEBUG of ps_step_size      : signal is "TRUE";
--attribute MARK_DEBUG of ps_done           : signal is "TRUE";
--attribute MARK_DEBUG of ps_status         : signal is "TRUE";     
--attribute MARK_DEBUG of pll_locked        : signal is "TRUE";
--attribute MARK_DEBUG of pll_reconfig      : signal is "TRUE";
--attribute MARK_DEBUG of pll_reset_req     : signal is "TRUE";
--attribute MARK_DEBUG of ps_ctrl_busy      : signal is "TRUE";
--attribute MARK_DEBUG of ps_ctrl_en        : signal is "TRUE";
--attribute MARK_DEBUG of ps_ctrl_phase     : signal is "TRUE";
--attribute MARK_DEBUG of ps_ctrl_cnt       : signal is "TRUE";
--attribute MARK_DEBUG of ps_ctrl_updown    : signal is "TRUE";
--attribute MARK_DEBUG of smpl_cmp_en       : signal is "TRUE";
--attribute MARK_DEBUG of smpl_cmp_done     : signal is "TRUE";
--attribute MARK_DEBUG of smpl_cmp_error    : signal is "TRUE";
