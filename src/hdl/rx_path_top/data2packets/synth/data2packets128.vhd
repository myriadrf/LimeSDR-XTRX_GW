-- ----------------------------------------------------------------------------	
-- FILE: 	data2packets128.vhd
-- DESCRIPTION:	Forms packets with provided header, outputting a double width (128bit) bus.
-- DATE:	Jul 15, 2021
...
entity data2packets128 is
   ...
   port (
      ...
      pct_q             : out std_logic_vector(127 downto 0)
...
-- Architecture
-- ----------------------------------------------------------------------------
architecture arch of data2packets128 is
--declare signals,  components here
signal reg_0      : std_logic_vector (127 downto 0); 
signal reg_1      : std_logic_vector (127 downto 0); 
signal reg_2      : std_logic_vector (127 downto 0); 
...
pct_data_wr_cnt_max_proc : process(reset_n, clk)
   begin
      if reset_n='0' then
         ...
         pct_data_wr_cnt_max <= unsigned(pct_size)-2;
      end if;
   end process;
...
reg_1_ld <= pct_data_wrreq;--reg_ld;
reg_1_en <= '0';
